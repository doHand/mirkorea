...
import {
  ClipboardList, PackageCheck, Plus, Search, ChevronRight, X,
} from 'lucide-react'
          ...
          <table className="w-full min-w-[700px] text-sm">
            ...
            <tbody className={ui.tbody}>
              ...
              {!isLoading && filtered.length === 0 && (
                <tr><td colSpan={7} className="text-center py-10 text-gray-400">입고 주문이 없습니다</td></tr>
              )}
              {filtered.map((order) => (
                <tr
                  key={order.id}
                ...
                >
                  ...
                  <td className="px-4 py-3 text-gray-700 dark:text-gray-300">
                    {order.supplier || <span className="text-gray-400">-</span>}
                  </td>
          ...
          <div>
            ...
            <div className="relative">
              ...
              {productPage && productPage.items.length > 0 && productSearch && (
                <div className="absolute z-10 top-full left-0 right-0 mt-1 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl shadow-lg max-h-48 overflow-y-auto">
