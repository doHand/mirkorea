...
const iconFor = (action: string) => action === 'DELETE' ? '삭제' : action === 'PATCH' || action === 'PUT' ? '수정' : '!'
...
export default function AlertsPage() {
  ...
  return <div className="flex h-[calc(100vh-150px)] min-h-0 flex-col gap-3 overflow-hidden">
    <div><h2 className="flex items-center gap-2 text-lg font-bold">알림</h2><p className="text-xs text-gray-500">수정·삭제 등 최근 변경 사항을 30초마다 갱신합니다.</p></div>
